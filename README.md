...
- UI 시스템: Widget Screen 기반, 단서·배터리·상호작용 표시  
- 빛 단서 퍼즐: 어두운 구간에 숨겨진 암호를 손전등으로 찾아 해석  
- 환경 퍼즐: 조명 패턴이 단서 역할, 잘못된 경로는 루프 구조 진입  
...
- **퍼즐 오브젝트**: 조명 스위치, 거울 반사 장치, 그림자 암호, 손전등, 단서 노트 UI
- **맵 구조**: 무한히 이어지는 폐쇄 복도, 어두운 구간, 출구 ‘빛의 아치’
...
| 8주 | 10.20~10.26 | 무한 복도 구조 테스트 | 반복 공간 구현 |
